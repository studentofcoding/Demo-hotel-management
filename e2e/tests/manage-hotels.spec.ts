...
test.beforeEach(async ({ page }) => {        //this is used to run the code before each test
  ...
  await page.locator("[name='email']").fill("shyaminda7257@gmail.com");  //here we are filling the email field with the email
  await page.locator("[name='password']").fill("12345678");  //here we are filling the password field with the password
